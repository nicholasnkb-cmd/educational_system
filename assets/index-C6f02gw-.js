(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))i(l);new MutationObserver(l=>{for(const d of l)if(d.type==="childList")for(const y of d.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&i(y)}).observe(document,{childList:!0,subtree:!0});function s(l){const d={};return l.integrity&&(d.integrity=l.integrity),l.referrerPolicy&&(d.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?d.credentials="include":l.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(l){if(l.ep)return;l.ep=!0;const d=s(l);fetch(l.href,d)}})();/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const it=(e,a,s=[])=>{const i=document.createElementNS("http://www.w3.org/2000/svg",e);return Object.keys(a).forEach(l=>{i.setAttribute(l,String(a[l]))}),s.length&&s.forEach(l=>{const d=it(...l);i.appendChild(d)}),i};var $t=([e,a,s])=>it(e,a,s);/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const St=e=>Array.from(e.attributes).reduce((a,s)=>(a[s.name]=s.value,a),{}),wt=e=>typeof e=="string"?e:!e||!e.class?"":e.class&&typeof e.class=="string"?e.class.split(" "):e.class&&Array.isArray(e.class)?e.class:"",kt=e=>e.flatMap(wt).map(s=>s.trim()).filter(Boolean).filter((s,i,l)=>l.indexOf(s)===i).join(" "),Mt=e=>e.replace(/(\w)(\w*)(_|-|\s*)/g,(a,s,i)=>s.toUpperCase()+i.toLowerCase()),at=(e,{nameAttr:a,icons:s,attrs:i})=>{var ie;const l=e.getAttribute(a);if(l==null)return;const d=Mt(l),y=s[d];if(!y)return console.warn(`${e.outerHTML} icon name was not found in the provided icons object.`);const g=St(e),[j,ue,pe]=y,se={...ue,"data-lucide":l,...i,...g},ne=kt(["lucide",`lucide-${l}`,g,i]);ne&&Object.assign(se,{class:ne});const me=$t([j,se,pe]);return(ie=e.parentNode)==null?void 0:ie.replaceChild(me,e)};/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const At=["svg",p,[["path",{d:"m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526"}],["circle",{cx:"12",cy:"8",r:"6"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pt=["svg",p,[["path",{d:"M10.268 21a2 2 0 0 0 3.464 0"}],["path",{d:"M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ct=["svg",p,[["path",{d:"M12 7v14"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Lt=["svg",p,[["path",{d:"M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"}],["path",{d:"M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"}],["path",{d:"M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"}],["path",{d:"M10 6h4"}],["path",{d:"M10 10h4"}],["path",{d:"M10 14h4"}],["path",{d:"M10 18h4"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Et=["svg",p,[["path",{d:"M8 2v4"}],["path",{d:"M16 2v4"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2"}],["path",{d:"M3 10h18"}],["path",{d:"M8 14h.01"}],["path",{d:"M12 14h.01"}],["path",{d:"M16 14h.01"}],["path",{d:"M8 18h.01"}],["path",{d:"M12 18h.01"}],["path",{d:"M16 18h.01"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dt=["svg",p,[["path",{d:"M20 6 9 17l-5-5"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ot=["svg",p,[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"}],["path",{d:"m9 14 2 2 4-4"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xt=["svg",p,[["circle",{cx:"12",cy:"12",r:"10"}],["polyline",{points:"12 6 12 12 16 14"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qt=["svg",p,[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5"}],["path",{d:"M3 12A9 3 0 0 0 21 12"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Tt=["svg",p,[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}],["polyline",{points:"7 10 12 15 17 10"}],["line",{x1:"12",x2:"12",y1:"15",y2:"3"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Rt=["svg",p,[["circle",{cx:"12",cy:"12",r:"1"}],["circle",{cx:"19",cy:"12",r:"1"}],["circle",{cx:"5",cy:"12",r:"1"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jt=["svg",p,[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"}],["circle",{cx:"12",cy:"12",r:"3"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const It=["svg",p,[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4"}],["path",{d:"M10 9H8"}],["path",{d:"M16 13H8"}],["path",{d:"M16 17H8"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ft=["svg",p,[["path",{d:"M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z"}],["path",{d:"M22 10v6"}],["path",{d:"M6 12.5V16a6 3 0 0 0 12 0v-3.5"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ht=["svg",p,[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bt=["svg",p,[["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2"}],["path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ut=["svg",p,[["path",{d:"M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z"}],["path",{d:"M15 5.764v15"}],["path",{d:"M9 3.236v15"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _t=["svg",p,[["path",{d:"m3 11 18-5v12L3 14v-3z"}],["path",{d:"M11.6 16.8a3 3 0 1 1-5.8-1.6"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zt=["svg",p,[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wt=["svg",p,[["path",{d:"M13.234 20.252 21 12.3"}],["path",{d:"m16 6-8.414 8.586a2 2 0 0 0 0 2.828 2 2 0 0 0 2.828 0l8.414-8.586a4 4 0 0 0 0-5.656 4 4 0 0 0-5.656 0l-8.415 8.585a6 6 0 1 0 8.486 8.486"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jt=["svg",p,[["path",{d:"M12 20h9"}],["path",{d:"M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vt=["svg",p,[["polygon",{points:"6 3 20 12 6 21 6 3"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yt=["svg",p,[["path",{d:"M5 12h14"}],["path",{d:"M12 5v14"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kt=["svg",p,[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"}],["path",{d:"M21 3v5h-5"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"}],["path",{d:"M8 16H3v5"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qt=["svg",p,[["path",{d:"M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"}],["path",{d:"m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"}],["path",{d:"M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"}],["path",{d:"M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zt=["svg",p,[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}],["path",{d:"M3 3v5h5"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xt=["svg",p,[["circle",{cx:"11",cy:"11",r:"8"}],["path",{d:"m21 21-4.3-4.3"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ea=["svg",p,[["path",{d:"M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"}],["path",{d:"m21.854 2.147-10.94 10.939"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ta=["svg",p,[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"}],["circle",{cx:"12",cy:"12",r:"3"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const aa=["svg",p,[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"}],["path",{d:"m9 12 2 2 4-4"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const sa=["svg",p,[["rect",{width:"14",height:"20",x:"5",y:"2",rx:"2",ry:"2"}],["path",{d:"M12 18h.01"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const na=["svg",p,[["path",{d:"M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"}],["path",{d:"M20 3v4"}],["path",{d:"M22 5h-4"}],["path",{d:"M4 17v2"}],["path",{d:"M5 18H3"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ia=["svg",p,[["path",{d:"M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oa=["svg",p,[["polyline",{points:"22 7 13.5 15.5 8.5 10.5 2 17"}],["polyline",{points:"16 7 22 7 22 13"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ra=["svg",p,[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"}],["path",{d:"M12 9v4"}],["path",{d:"M12 17h.01"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ca=["svg",p,[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"}],["circle",{cx:"9",cy:"7",r:"4"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const la=["svg",p,[["path",{d:"m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"}],["rect",{x:"2",y:"6",width:"14",height:"12",rx:"2"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const da=["svg",p,[["path",{d:"M18 6 6 18"}],["path",{d:"m6 6 12 12"}]]];/**
 * @license lucide v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ua=({icons:e={},nameAttr:a="data-lucide",attrs:s={}}={})=>{if(!Object.values(e).length)throw new Error(`Please provide an icons object.
If you want to use all the icons you can import it like:
 \`import { createIcons, icons } from 'lucide';
lucide.createIcons({icons});\``);if(typeof document>"u")throw new Error("`createIcons()` only works in a browser environment.");const i=document.querySelectorAll(`[${a}]`);if(Array.from(i).forEach(l=>at(l,{nameAttr:a,icons:e,attrs:s})),a==="data-lucide"){const l=document.querySelectorAll("[icon-name]");l.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(l).forEach(d=>at(d,{nameAttr:"icon-name",icons:e,attrs:s})))}},q=[{id:"state-admin",label:"State Admin",icon:"map",image:"/stitch_educonnect_interactive_portal/teacher_dashboard/screen.png"},{id:"district-admin",label:"District Admin",icon:"building-2",image:"/stitch_educonnect_interactive_portal/teacher_dashboard/screen.png"},{id:"school-admin",label:"School Admin",icon:"shield-check",image:"/stitch_educonnect_interactive_portal/teacher_dashboard/screen.png"},{id:"lms",label:"LMS",icon:"layers",image:"/stitch_educonnect_interactive_portal/teacher_dashboard/screen.png"},{id:"student",label:"Student",icon:"sparkles",image:"/stitch_educonnect_interactive_portal/student_portal_1/screen.png"},{id:"teacher",label:"Teacher",icon:"graduation-cap",image:"/stitch_educonnect_interactive_portal/teacher_dashboard/screen.png"},{id:"parent",label:"Parent",icon:"users",image:"/stitch_educonnect_interactive_portal/parent_dashboard/screen.png"},{id:"messages",label:"Messages",icon:"message-circle",image:"/stitch_educonnect_interactive_portal/communication_hub/screen.png"},{id:"community",label:"Community",icon:"megaphone",image:"/stitch_educonnect_interactive_portal/communication_hub/screen.png"}],t={role:"state-admin",selectedState:"ny",selectedDistrict:"nyc-doe",selectedSchool:"ps-118",completed:[],selectedClass:"All",checkedDeadlines:["Science: Water Cycle Model"],conversationFilter:"Parents",activeConversationId:"sarah",draft:"",boardAudience:"All families",activeAccount:"teacher-school",selectedSubmissionId:"sub-1",rosterFilter:"All",liveUpdates:!0,realtimeTick:0,activeCallName:"",gatewayMode:"demo",backendProvider:"Supabase",authProvider:"Role-based demo auth",offlinePackReady:!1,workHoursOpen:!0,emergencyOverride:!1,currentUser:"state-admin",apiMode:"local",tourOpen:!1,tourStep:0,searchTerm:"",notificationsOpen:!1,settingsOpen:!1,toast:"",compactMode:!1,highContrast:!1,guardrails:{lockSubmissions:!0,hideAnswers:!0,parentSummaries:!0}},A=[{id:"state-admin",label:"NYS State Admin",role:"State Admin",landing:"state-admin",scope:"state",stateId:"ny",permissions:["manage-tenants","approve-posts","emergency","lms","teacher-tools","message","manage-users","view-compliance"]},{id:"district-admin",label:"District Admin",role:"District Admin",landing:"district-admin",scope:"district",stateId:"ny",districtId:"nyc-doe",permissions:["manage-tenants","approve-posts","emergency","lms","teacher-tools","message","manage-users","view-compliance"]},{id:"school-admin",label:"School Admin",role:"School Admin",landing:"school-admin",scope:"school",stateId:"ny",districtId:"nyc-doe",schoolId:"ps-118",permissions:["approve-posts","emergency","lms","teacher-tools","message","manage-users","view-compliance"]},{id:"teacher",label:"Prof. Miller",role:"Teacher",landing:"teacher",scope:"school",stateId:"ny",districtId:"nyc-doe",schoolId:"ps-118",permissions:["lms","teacher-tools","message","submit-post"]},{id:"student",label:"Hero",role:"Student",landing:"student",scope:"student",stateId:"ny",districtId:"nyc-doe",schoolId:"ps-118",studentId:"leo",permissions:["student-missions"]},{id:"parent",label:"Sarah Jenkins",role:"Parent",landing:"parent",scope:"guardian",stateId:"ny",districtId:"nyc-doe",schoolId:"ps-118",studentIds:["leo"],permissions:["message","submit-post"]}],pa=[["manage-tenants","Manage tenants"],["manage-users","Manage users"],["view-compliance","View compliance"],["approve-posts","Approve posts"],["emergency","Emergency override"],["lms","Manage LMS"],["teacher-tools","Teacher tools"],["message","Messaging"],["submit-post","Submit posts"],["student-missions","Student missions"]],fe=[{id:1,subject:"Science",title:"Space Explorers: The Moon",due:"Due tomorrow",action:"Start Mission",progress:78,accent:"teal",icon:"rocket"},{id:2,subject:"Math",title:"Number Quest: Addition",due:"Due in 2 days",action:"Play Now",progress:44,accent:"blue",icon:"star"},{id:3,subject:"Reading",title:"The Whale and the Star",due:"Keep reading",action:"Continue",progress:56,accent:"gold",icon:"book-open"}],V=[{id:"ny",name:"New York",agency:"NYS Education Department (NYSED)",districts:[{id:"nyc-doe",name:"New York City Public Schools",region:"New York City",superintendent:"NYC Chancellor",schools:[{id:"ps-118",name:"P.S. 118 Discovery Academy",category:"Public",students:684,staff:78,status:"Active",subdomain:"ps118",plan:"District Core",modules:["SIS","LMS","Messaging","Family Portal"],storage:64,uptime:"99.98%",theme:"Discovery Blue",isolation:"Dedicated tenant database",avgGrade:"88.4%",attendance:"94.2%",messages:"3 pending",studentPoints:1240,studentName:"Hero",guardianName:"Sarah",learnerName:"Leo",workHours:"Mon-Fri, 8:00 AM-4:30 PM",afterHours:"Messages are held until the next work day"},{id:"bronx-charter",name:"Bronx Learning Charter",category:"Chartered",students:412,staff:49,status:"Onboarding",subdomain:"bronxlearning",plan:"Charter Launch",modules:["SIS","Messaging","Enrollment"],storage:31,uptime:"99.91%",theme:"Charter Gold",isolation:"Dedicated tenant database",avgGrade:"86.1%",attendance:"92.7%",messages:"8 pending",studentPoints:890,studentName:"Explorer",guardianName:"Monica",learnerName:"Ari",workHours:"Mon-Fri, 7:45 AM-4:00 PM",afterHours:"Messages are held until staff office hours reopen"}]},{id:"albany-csd",name:"Albany City School District",region:"Capital Region",superintendent:"District Superintendent",schools:[{id:"albany-prep",name:"Albany Preparatory School",category:"Private",students:325,staff:44,status:"Active",subdomain:"albanyprep",plan:"Private Plus",modules:["LMS","Messaging","Tuition","Family Portal"],storage:46,uptime:"99.95%",theme:"Prep Teal",isolation:"Dedicated tenant database",avgGrade:"91.8%",attendance:"96.4%",messages:"1 pending",studentPoints:1565,studentName:"Scholar",guardianName:"Priya",learnerName:"Noah",workHours:"Mon-Fri, 8:30 AM-5:00 PM",afterHours:"Messages wait for the next administrator-approved window"},{id:"eagle-point",name:"Eagle Point Elementary",category:"Public",students:538,staff:61,status:"Active",subdomain:"eaglepoint",plan:"District Core",modules:["SIS","LMS","Messaging"],storage:52,uptime:"99.97%",theme:"Eagle Green",isolation:"Dedicated tenant database",avgGrade:"87.2%",attendance:"95.1%",messages:"4 pending",studentPoints:1120,studentName:"Navigator",guardianName:"Sarah",learnerName:"Mia",workHours:"Mon-Fri, 8:00 AM-4:00 PM",afterHours:"Messages are queued until office hours"}]}]},{id:"ca",name:"California",agency:"California Department of Education",districts:[{id:"la-usd",name:"Los Angeles Unified School District",region:"Los Angeles County",superintendent:"District Superintendent",schools:[{id:"pacific-stem",name:"Pacific STEM Charter",category:"Chartered",students:496,staff:52,status:"Active",subdomain:"pacificstem",plan:"STEM Charter",modules:["SIS","LMS","Messaging","Lab Scheduler"],storage:58,uptime:"99.94%",theme:"Pacific Blue",isolation:"Dedicated tenant database",avgGrade:"90.3%",attendance:"93.8%",messages:"6 pending",studentPoints:1325,studentName:"Innovator",guardianName:"Elena",learnerName:"Kai",workHours:"Mon-Fri, 8:00 AM-4:30 PM",afterHours:"Messages are held until staff work hours"}]}]}],ma=[["State Governance",["Board of Regents","Commissioner of Education","NYS Education Department (NYSED)"]],["District & Regional Governance",["BOCES District Superintendents","Local Board of Education (BOE)","District Superintendent / NYC Chancellor","Assistant / Deputy Superintendents","District Directors / Coordinators"]],["School Building Administration",["Principal","Assistant Principal","Dean of Students / Department Chairs"]],["Classroom Faculty",["Tenured Teachers","Probationary Teachers","Substitutes / Leave Replacements"]],["Instructional & Specialized Support",["Specialized Clinicians","Teaching Assistants","Teacher Aides / Paraprofessionals"]],["Operational Support",["Secretaries / Clerical Staff","Custodial / Maintenance Staff","Food Service / Security / Transportation"]],["Student Leadership & Student Body",["Student Board of Education Representative","Student Council President / Officers","Class Officers","Club Presidents / Team Captains","General Student Body"]]],F=[{name:"English Literature",room:"Period 2, Room 304",grade:89,attendance:96,pending:12},{name:"Creative Writing",room:"Period 4, Room 201",grade:92,attendance:97,pending:1},{name:"Basic English",room:"Period 6, Room 118",grade:84,attendance:91,pending:5}],k=[{id:"stu-1",student:"Leo Jenkins",guardian:"Sarah Jenkins",teacher:"Prof. Miller",className:"English Literature",grade:91,attendance:98,accommodations:"Visual vocabulary cards",status:"Active"},{id:"stu-2",student:"Maya Rodriguez",guardian:"Elena Rodriguez",teacher:"Prof. Miller",className:"Creative Writing",grade:88,attendance:94,accommodations:"Extended quiz time",status:"Active"},{id:"stu-3",student:"Liam Wilson",guardian:"Marcus Wilson",teacher:"Prof. Miller",className:"English Literature",grade:82,attendance:91,accommodations:"Reading support",status:"Watch"},{id:"stu-4",student:"Sarah Chen",guardian:"Priya Chen",teacher:"Prof. Miller",className:"Creative Writing",grade:96,attendance:99,accommodations:"None",status:"Active"}],M=[{id:"sub-1",student:"Leo Jenkins",assignment:"Fractions Mastery Check",status:"Submitted",score:88,rubric:[["Concepts",4],["Accuracy",3],["Explanation",4],["Neatness",3]],comment:"Strong reasoning. Recheck mixed-number conversions."},{id:"sub-2",student:"Maya Rodriguez",assignment:"Great Depression Essay",status:"Needs review",score:74,rubric:[["Thesis",3],["Evidence",3],["Organization",2],["Conventions",4]],comment:"Good evidence. Add a clearer argument in the introduction."},{id:"sub-3",student:"Liam Wilson",assignment:"Grammar Quiz - Week 5",status:"Missing",score:0,rubric:[["Completion",0],["Accuracy",0],["Timeliness",0]],comment:"Family reminder queued."}],W=[["Liam Wilson","finished reading The Great Gatsby","15 minutes ago","Lit 101"],["Sarah Chen","submitted Grammar Quiz - Week 5","42 minutes ago","Creative Writing"],["Marcus Thorne","posted in the discussion board","2 hours ago","Shakespeare"]],we=[{title:"History: Great Depression Essay",meta:"Due tomorrow, 11:59 PM",urgent:!0},{title:"Science: Water Cycle Model",meta:"Due Thursday",urgent:!1},{title:"Math: Quadratic Equations Quiz",meta:"Due Sunday",urgent:!1}],C=[{id:"fractions",title:"Fractions Mastery Check",type:"Automated quiz",rubric:"4-domain rubric",analytics:82,lockDate:"Oct 24, 8:00 PM",exception:"Maya R. +24h"},{id:"essay",title:"Great Depression Essay",type:"Writing task",rubric:"Argument + evidence rubric",analytics:74,lockDate:"Oct 28, 11:59 PM",exception:"None"}],oe=[{name:"Water Cycle Worksheet.docx",status:"Converted to editable lesson copy",type:"Word"},{name:"Moon Lab Packet.pdf",status:"OCR indexed + annotation ready",type:"PDF"},{name:"Parent Signature Form.pdf",status:"Fillable fields detected",type:"PDF"}],$e=[{id:"teacher-school",name:"Prof. Miller",context:"Teacher at selected school",active:!0},{id:"parent-school",name:"Sarah Jenkins",context:"Parent profile",active:!1},{id:"district-admin",name:"District Admin",context:"District-wide oversight",active:!1}],L=[{id:"notice-lock-window",level:"Urgent",title:"Locked submission window closes tonight",target:"Grade 4 Math",channel:"Dashboard + SMS",read:!1},{id:"notice-rubrics",level:"Action",title:"3 rubric scores need review",target:"English Literature",channel:"Teacher inbox",read:!1},{id:"notice-family-comment",level:"FYI",title:"New family comment on community board",target:"All families",channel:"Digest",read:!1}],D=[{id:"live-1",type:"Roster",title:"Leo Jenkins attendance synced",detail:"SIS updated attendance to 98%.",time:"Live now"},{id:"live-2",type:"LMS",title:"Rubric queue refreshed",detail:"3 submissions are ready for review.",time:"Live now"},{id:"live-3",type:"Messages",title:"Parent digest prepared",detail:"Routine updates will send during the next work window.",time:"Live now"}],st=[{app:"Docs",action:"Distribute editable templates instantly",status:"Connected"},{app:"Drive",action:"Attach, collect, and archive class files",status:"Connected"},{app:"Forms",action:"Auto-create quizzes with answer visibility rules",status:"Connected"},{app:"Slides",action:"Share lesson decks as view or copy templates",status:"Connected"}],ha=[["Intuitive Design","Clean teacher and student workflows with minimal training."],["Zero Cost Base","Core classroom, assignments, communication, and family summaries stay free for schools."],["Paperless Workflow","Create, collect, grade, return, and archive digital assignments."],["Centralized Communication","Class announcements, direct messages, and parent summaries in one place."],["Automated Guardrails","Lock edits after submission and hide quiz answers until the assessment ends."]],R=[{actor:"District Admin",event:"Provisioned school tenant",scope:"NYC DOE",time:"Today 9:12 AM"},{actor:"Principal Rivera",event:"Approved community board post",scope:"P.S. 118",time:"Today 10:44 AM"},{actor:"System",event:"Blocked after-hours parent message",scope:"P.S. 118",time:"Yesterday 6:03 PM"},{actor:"NYSED Reviewer",event:"Viewed compliance dashboard",scope:"New York",time:"Yesterday 2:21 PM"}],ga=[{label:"FERPA Mode",status:"Enabled",detail:"Student records are hidden outside authorized tenant scopes."},{label:"Media Review",status:"Required",detail:"Photos and files stay pending until an assigned approver approves them."},{label:"Data Export",status:"Logged",detail:"Every roster, gradebook, or message export appears in the audit trail."}],va=[{label:"FERPA access reviews",value:"12",status:"Due this month",detail:"Confirm staff access for student records."},{label:"Data export logs",value:"4",status:"Reviewed",detail:"Gradebook and roster exports are audit logged."},{label:"Media approvals",value:"1",status:"Pending",detail:"Photo content waiting for administrator approval."},{label:"After-hours blocks",value:"7",status:"Protected",detail:"Messages held outside school communication windows."}],ot=[{title:"Superintendent Hearing Window",audience:"District",date:"Oct 21",type:"Compliance"},{title:"Science Night",audience:"P.S. 118 families",date:"Oct 23",type:"Community"},{title:"Fractions Mastery Lock Date",audience:"Grade 4 Math",date:"Oct 24",type:"LMS"},{title:"Parent Conference Block",audience:"Teachers + guardians",date:"Oct 27",type:"Messaging"}],te=[{item:"Fractions quiz attempt",owner:"Leo",status:"Queued for upload"},{item:"PDF annotation packet",owner:"Maya",status:"Conflict check ready"},{item:"Teacher rubric draft",owner:"Prof. Miller",status:"Saved offline"}],ba=[["Default route","Parent and teacher posts go to the first active school approver."],["Media route","Photos, videos, and files require Principal or Assistant Principal approval."],["Sensitive route","Discipline, health, or student-identifying content is held for administrator review."],["Publishing rule","Approved posts publish only inside the selected school tenant."]],fa=[{title:"One-tap teacher message",detail:"Disabled automatically outside school work hours."},{title:"Digest-first notifications",detail:"Urgent alerts separate from routine activity noise."},{title:"Offline packet pickup",detail:"Assignments and forms can be downloaded before Wi-Fi drops."}],N={"ps-118":{logo:"D",crest:"Discovery Owls",primary:"#0050cb",accent:"#006b5f",highlight:"#735c00",background:"#f8f9ff",voice:"Bright, curious, elementary STEM"},"bronx-charter":{logo:"B",crest:"Bronx Torch",primary:"#6d3f00",accent:"#005b96",highlight:"#996b00",background:"#fff9ef",voice:"Confident, college-bound, community first"},"albany-prep":{logo:"A",crest:"Albany Shield",primary:"#005f73",accent:"#7a3e9d",highlight:"#8a5a00",background:"#f3fbfb",voice:"Polished, private school, seminar-ready"},"eagle-point":{logo:"E",crest:"Eagle Point",primary:"#116149",accent:"#004e98",highlight:"#7c5c00",background:"#f4fbf6",voice:"Warm, neighborhood public school"},"pacific-stem":{logo:"P",crest:"Pacific Wave",primary:"#0057a8",accent:"#00756f",highlight:"#7a6100",background:"#f2f8ff",voice:"Modern, STEM lab, project-based"}},ya=[{name:"Discovery Blue",primary:"#0050cb",accent:"#006b5f",highlight:"#735c00",background:"#f8f9ff"},{name:"Charter Gold",primary:"#6d3f00",accent:"#005b96",highlight:"#996b00",background:"#fff9ef"},{name:"Prep Teal",primary:"#005f73",accent:"#7a3e9d",highlight:"#8a5a00",background:"#f3fbfb"},{name:"Eagle Green",primary:"#116149",accent:"#004e98",highlight:"#7c5c00",background:"#f4fbf6"},{name:"Pacific Blue",primary:"#0057a8",accent:"#00756f",highlight:"#7a6100",background:"#f2f8ff"}],S=[{id:"sarah",name:"Sarah Jenkins",role:"Leo's parent",type:"Parents",unread:0,online:!0,preview:"I'll send the photo of the worksheet now...",messages:[{from:"them",text:"Hi Mr. Anderson! Leo found the fractions section tricky.",time:"13:45"},{from:"me",text:"Thanks for the heads up. I can send a visual practice sheet today.",time:"13:52"},{from:"them",text:"That would help. I'll send the photo of the worksheet now.",time:"14:02"}]},{id:"elena",name:"Elena Rodriguez",role:"Maya's parent",type:"Parents",unread:3,online:!1,preview:"Is the field trip still happening on Friday?",messages:[{from:"them",text:"Is the field trip still happening on Friday?",time:"Tue"},{from:"me",text:"Yes, the permission forms are due by Thursday morning.",time:"Tue"}]},{id:"grade-team",name:"Grade 4 Team",role:"6 teachers",type:"Groups",unread:1,online:!0,preview:"New reading groups are posted.",messages:[{from:"them",text:"New reading groups are posted for next week.",time:"09:18"},{from:"me",text:"Great, I updated my small-group rotation.",time:"09:26"}]}],O={"ps-118":{approvers:[{id:"principal-rivera",name:"Principal Rivera",title:"Principal",active:!0},{id:"ap-kim",name:"Assistant Principal Kim",title:"Assistant Principal",active:!0},{id:"dean-walker",name:"Dean Walker",title:"Dean of Students",active:!1}],published:[{id:"ps-post-1",author:"Ms. Henderson",role:"Teacher",type:"Announcement",audience:"All families",title:"Science Night Volunteers",body:"We need four family volunteers for Thursday's hands-on moon lab.",media:"Flyer PDF",time:"Approved today"},{id:"ps-post-2",author:"Sarah Jenkins",role:"Parent",type:"Resource",audience:"Grade 4",title:"Math Game Practice Link",body:"Sharing a free fractions game that helped Leo practice at home.",media:"Website link",time:"Approved yesterday"}],pending:[{id:"ps-pending-1",author:"Mr. Anderson",role:"Teacher",type:"Photo",audience:"Grade 4",title:"Moon Rock Lab Photos",body:"A photo set from today's science station rotation.",media:"6 images",approverId:"principal-rivera",time:"Awaiting principal approval"}]}},Y=[{name:"users",records:A.length,status:"Mapped",detail:"Role, permission, school, guardian/student links"},{name:"schools",records:5,status:"Mapped",detail:"State, district, tenant URL, modules, branding"},{name:"classes",records:F.length,status:"Mapped",detail:"Teacher, room, attendance, pending work"},{name:"students",records:k.length,status:"Mapped",detail:"Guardian, accommodations, grades, attendance"},{name:"assignments",records:C.length,status:"Mapped",detail:"Type, rubric, lock date, exceptions"},{name:"submissions",records:M.length,status:"Mapped",detail:"Rubric scores, comments, review status"},{name:"messages",records:S.length,status:"Mapped",detail:"Parent and group threads with work-hour controls"},{name:"community_posts",records:O["ps-118"].published.length+O["ps-118"].pending.length,status:"Mapped",detail:"Approvals, media, audience, publishing state"},{name:"audit_logs",records:R.length,status:"Mapped",detail:"Admin actions, exports, compliance events"}],U=[{id:"district",label:"Create district and school tenants",owner:"Admin",done:!0},{id:"staff",label:"Invite staff accounts",owner:"Admin",done:!0},{id:"roster",label:"Import student roster",owner:"Registrar",done:!0},{id:"guardians",label:"Connect parent and guardian accounts",owner:"School office",done:!1},{id:"classes",label:"Assign teachers to classes",owner:"Principal",done:!0},{id:"launch",label:"Send launch notification",owner:"Communications",done:!1}],x=[{id:"upload-1",name:"Moon Lab Packet.pdf",area:"LMS",size:"1.2 MB",status:"Ready for class distribution"},{id:"upload-2",name:"Science Night Flyer.pdf",area:"Community",size:"420 KB",status:"Waiting for approval"}],_=[{id:"delivery-1",channel:"Email",audience:"Grade 4 families",status:"Queued",detail:"Science Night reminder"},{id:"delivery-2",channel:"SMS",audience:"Emergency contacts",status:"Ready",detail:"Emergency override test"},{id:"delivery-3",channel:"Push",audience:"Teachers",status:"Delivered",detail:"Rubric queue refresh"}],z=[{id:"auth",label:"Role-based authentication rules",status:"Configured",done:!0},{id:"ferpa",label:"FERPA tenant data isolation",status:"Configured",done:!0},{id:"audit",label:"Audit log export policy",status:"Configured",done:!0},{id:"backups",label:"Nightly database backups",status:"Needs backend provider",done:!1},{id:"encryption",label:"Encrypted file storage",status:"Needs storage provider",done:!1},{id:"retention",label:"Data retention schedule",status:"Drafted",done:!1}],re=[{step:"Build",status:"Passing",detail:"Vite production build generates static assets"},{step:"Tests",status:"Passing",detail:"Playwright local and live smoke tests available"},{step:"FTP deploy",status:"Live",detail:"educationalsystem.fieldserviceit.com is serving the app"},{step:"GitHub sync",status:"Connected",detail:"Backend repository deploys through Hostinger hPanel"}],$a="educationalsystem.fieldserviceit.com",Sa="https://api.educationalsystem.fieldserviceit.com";function wa(e,a="",s=""){return e===$a?Sa:a||s||""}const rt="educonnect-mock-api-v1";let ee=0,ce="localStorage://educonnect-mock-api-v1",K="Ready";function ct(e){return e&&typeof e=="object"&&"data"in e?e.data:e}function lt(){return new Promise(e=>setTimeout(e,80))}function dt(){return wa(window.location.hostname,window.__EDUCONNECT_API_BASE__,void 0)}function ut(){const e=localStorage.getItem("educonnect-session-token");return e?{Authorization:`Bearer ${e}`}:{}}async function pt(e,a){const s=`${dt()}/api/state`;ce=s;const i=await fetch(s,{method:e,headers:{"Content-Type":"application/json",...ut()},body:a?JSON.stringify(a):void 0});if(ee+=1,!i.ok)throw K=`HTTP ${i.status}`,new Error(`Server API request failed with ${i.status}`);return K="Connected",ct(await i.json())}async function ke(e,a={}){const s=`${dt()}${e}`;ce=s;const i=await fetch(s,{headers:{"Content-Type":"application/json",...ut(),...a.headers||{}},...a});if(ee+=1,!i.ok){K=`HTTP ${i.status}`;const l=await i.json().catch(()=>({}));throw new Error(l.error||`Server API request failed with ${i.status}`)}return K="Connected",ct(await i.json())}async function ka(e,a="mock-api"){return a==="live-api"?pt("PUT",{snapshot:e}):(ee+=1,await lt(),localStorage.setItem(rt,JSON.stringify(e)),ce="localStorage://educonnect-mock-api-v1",K="Ready",{ok:!0,requestCount:ee})}async function Ma(e="mock-api"){return e==="live-api"?(await pt("GET")).snapshot:(ee+=1,await lt(),ce="localStorage://educonnect-mock-api-v1",K="Ready",JSON.parse(localStorage.getItem(rt)||"null"))}function Aa(){return{requestCount:ee,endpoint:ce,status:K}}async function Pa(e,a){return ke("/api/login",{method:"POST",body:JSON.stringify({profileId:e,password:a})})}async function Ca(e,a="LMS"){const s=await new Promise((i,l)=>{const d=new FileReader;d.onload=()=>i(String(d.result).split(",")[1]||""),d.onerror=()=>l(d.error),d.readAsDataURL(e)});return ke("/api/files",{method:"POST",body:JSON.stringify({name:e.name,type:e.type,area:a,size:`${Math.max(1,Math.round(e.size/1024))} KB`,contentBase64:s})})}async function La(e="Launch test group"){return ke("/api/notifications/test",{method:"POST",body:JSON.stringify({audience:e})})}const he="educonnect-demo-state-v1",$=structuredClone({state:t,userProfiles:A,tenantStates:V,schoolDesigns:N,rosterRecords:k,gradebookSubmissions:M,auditLogs:R,lmsAssignments:C,lmsFiles:oe,lmsNotifications:L,realtimeEvents:D,databaseTables:Y,onboardingTasks:U,fileUploads:x,notificationDeliveryLog:_,securityChecklist:z,deployPipeline:re,offlineSyncQueue:te,activityFeed:W,conversations:S,communityBoards:O});function ge(e,a){Object.keys(e).forEach(s=>delete e[s]),Object.assign(e,structuredClone(a))}function h(e,a){e.splice(0,e.length,...structuredClone(a))}function Ea(){try{const e=JSON.parse(localStorage.getItem(he)||"null");Me(e)}catch{localStorage.removeItem(he)}}function mt(){return structuredClone({state:t,userProfiles:A,tenantStates:V,schoolDesigns:N,rosterRecords:k,gradebookSubmissions:M,auditLogs:R,lmsAssignments:C,lmsFiles:oe,lmsNotifications:L,realtimeEvents:D,databaseTables:Y,onboardingTasks:U,fileUploads:x,notificationDeliveryLog:_,securityChecklist:z,deployPipeline:re,offlineSyncQueue:te,activityFeed:W,conversations:S,communityBoards:O})}function Me(e){e&&(e.state&&Object.assign(t,e.state),e.userProfiles&&h(A,e.userProfiles),e.tenantStates&&h(V,e.tenantStates),e.schoolDesigns&&ge(N,e.schoolDesigns),e.rosterRecords&&h(k,e.rosterRecords),e.gradebookSubmissions&&h(M,e.gradebookSubmissions),e.auditLogs&&h(R,e.auditLogs),e.lmsAssignments&&h(C,e.lmsAssignments),e.lmsFiles&&h(oe,e.lmsFiles),e.lmsNotifications&&h(L,e.lmsNotifications),e.realtimeEvents&&h(D,e.realtimeEvents),e.databaseTables&&h(Y,e.databaseTables),e.onboardingTasks&&h(U,e.onboardingTasks),e.fileUploads&&h(x,e.fileUploads),e.notificationDeliveryLog&&h(_,e.notificationDeliveryLog),e.securityChecklist&&h(z,e.securityChecklist),e.deployPipeline&&h(re,e.deployPipeline),e.offlineSyncQueue&&h(te,e.offlineSyncQueue),e.activityFeed&&h(W,e.activityFeed),e.conversations&&h(S,e.conversations),e.communityBoards&&ge(O,e.communityBoards))}function Da(){const e=mt();localStorage.setItem(he,JSON.stringify(e)),(t.apiMode==="mock-api"||t.apiMode==="live-api")&&ka(e,t.apiMode).catch(()=>{})}async function ht(e=t.apiMode){const a=await Ma(e);a&&Me(a)}function Na(){localStorage.removeItem(he),Object.assign(t,structuredClone($.state)),h(A,$.userProfiles),h(V,$.tenantStates),ge(N,$.schoolDesigns),h(k,$.rosterRecords),h(M,$.gradebookSubmissions),h(R,$.auditLogs),h(C,$.lmsAssignments),h(oe,$.lmsFiles),h(L,$.lmsNotifications),h(D,$.realtimeEvents),h(Y,$.databaseTables),h(U,$.onboardingTasks),h(x,$.fileUploads),h(_,$.notificationDeliveryLog),h(z,$.securityChecklist),h(re,$.deployPipeline),h(te,$.offlineSyncQueue),h(W,$.activityFeed),h(S,$.conversations),ge(O,$.communityBoards)}const Oa=document.querySelector("#app"),G=[{title:"Choose a role",body:"Use the demo login panel to switch between state, district, school, teacher, parent, and student access.",role:"state-admin"},{title:"Create learning work",body:"Teachers and admins can create assignments and build offline packs in the LMS.",role:"lms"},{title:"Communicate safely",body:"Messaging respects school work hours, with emergency override reserved for admins.",role:"messages"},{title:"Approve community posts",body:"Admins can approve posts before they publish to the school community board.",role:"community"}],xa={AlertTriangle:ra,Award:At,Bell:Pt,BookOpen:Ct,Building2:Lt,CalendarDays:Et,Check:Dt,ChevronRight:Nt,ClipboardCheck:Ot,Clock:xt,Database:qt,Download:Tt,Eye:jt,FileText:It,GraduationCap:Ft,Layers:Gt,Lock:Ht,Mail:Bt,Map:Ut,Megaphone:_t,MessageCircle:zt,MoreHorizontal:Rt,Paperclip:Wt,PenLine:Jt,Play:Vt,Plus:Yt,RefreshCw:Kt,Rocket:Qt,RotateCcw:Zt,Search:Xt,Send:ea,Settings:ta,ShieldCheck:aa,Smartphone:sa,Sparkles:na,Star:ia,TrendingUp:oa,Users:ca,Video:la,X:da};function r(e){return`<i class="app-icon" data-lucide="${e}" data-icon="${e}" aria-hidden="true"></i>`}function qa(e){return`/${e.replace(/^\/+/,"")}`}function Q(e){return e.split(" ").map(a=>a[0]).slice(0,2).join("")}function le(e){return`<div class="progress" aria-label="${e}% complete"><span style="width:${e}%"></span></div>`}function w(e,a,s,i){return`<article class="stat-card ${i}"><div class="stat-icon">${r(s)}</div><span>${e}</span><strong>${a}</strong></article>`}function H(e){return String(e).replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function v(e){t.toast=e,m()}function f(e,a=b().name,s=ye().label){R.unshift({actor:s,event:e,scope:a,time:"Just now"})}function B(e,a,s=b().name,i="Live dashboard"){L.unshift({id:`notice-${Date.now()}-${Math.random().toString(16).slice(2)}`,level:e,title:a,target:s,channel:i,read:!1})}function P(e,a,s){D.unshift({id:`live-${Date.now()}-${Math.random().toString(16).slice(2)}`,type:e,title:a,detail:s,time:"Just now"}),D.length>8&&(D.length=8)}function ve(){return L.filter(e=>!e.read).length}function gt(e="manual"){const a=b(),s=[()=>{const i=k[t.realtimeTick%k.length];i.attendance=Math.min(100,i.attendance+1),W.unshift([i.student,"attendance synced from SIS","Just now",i.className]),P("Roster",`${i.student} synced`,`Attendance is now ${i.attendance}% in ${i.className}.`),B("FYI",`${i.student} roster sync completed`,i.className,"SIS")},()=>{const i=M[t.realtimeTick%M.length];i.status=i.status==="Missing"?"Needs review":i.status,P("LMS",`${i.student} gradebook updated`,`${i.assignment} is ${i.status.toLowerCase()}.`),B("Action",`${i.student} submission needs attention`,i.assignment,"Teacher inbox")},()=>{const i=S.find(l=>l.id===t.activeConversationId)||S[0];i.messages.push({from:"them",text:`Live ${a.name} update received.`,time:"Now"}),i.preview="Live school update received.",i.unread=(i.unread||0)+1,P("Messages",`New message from ${i.name}`,"Conversation preview and unread count updated."),B("Urgent",`New message from ${i.name}`,a.name,"Messages")}];s[t.realtimeTick%s.length](),t.realtimeTick+=1,f(`Processed ${e} live update`,a.name,"Realtime service"),t.toast="Live app data updated.",m()}function ye(){return A.find(e=>e.id===t.currentUser)||A[0]}function J(e){return ye().permissions.includes(e)}function T(e,a="This role cannot use that action"){return J(e)?"":`disabled aria-disabled="true" title="${a}"`}function ae(e,a){return J(e)?"":`<div class="permission-note">${r("lock")} ${a}</div>`}function Ta(e){const a=[];return(!e||typeof e!="object")&&a.push("File must contain a JSON object."),(!(e!=null&&e.state)||typeof e.state!="object")&&a.push("Missing state object."),Array.isArray(e==null?void 0:e.tenantStates)||a.push("Missing tenantStates array."),Array.isArray(e==null?void 0:e.conversations)||a.push("Missing conversations array."),(!(e!=null&&e.communityBoards)||typeof e.communityBoards!="object")&&a.push("Missing communityBoards object."),a}function Se(){const e=window.location.hash.replace("#","");return e==="platform"?"state-admin":q.some(a=>a.id===e)?e:""}function be(e,a=!0){e==="platform"&&(e="state-admin"),q.some(s=>s.id===e)&&(t.role=e,t.notificationsOpen=!1,t.settingsOpen=!1,a&&window.location.hash!==`#${e}`&&history.pushState(null,"",`#${e}`),m())}function X(e,a=""){a&&(t.toast=a),be(e)}function vt(){ua({icons:xa,attrs:{"stroke-width":2.25}})}function de(){return V.find(e=>e.id===t.selectedState)||V[0]}function Z(){const e=de();return e.districts.find(a=>a.id===t.selectedDistrict)||e.districts[0]}function b(){const e=Z();return e.schools.find(a=>a.id===t.selectedSchool)||e.schools[0]}function Ra(){const e=b();return[...q.map(a=>({label:a.label,detail:"Workspace",role:a.id})),...fe.map(a=>({label:a.title,detail:`${a.subject} mission`,role:"student"})),...F.map(a=>({label:a.name,detail:a.room,role:"teacher"})),...C.map(a=>({label:a.title,detail:`${a.type} in LMS`,role:"lms"})),...we.map(a=>({label:a.title,detail:a.meta,role:"parent"})),...S.map(a=>({label:a.name,detail:a.preview,role:"messages"})),...E().published.map(a=>({label:a.title,detail:`${a.type} post`,role:"community"})),{label:e.name,detail:`${e.category} school tenant`,role:"school-admin"}]}function ja(){const e=t.searchTerm.trim().toLowerCase();if(!e)return"";const a=Ra().filter(s=>`${s.label} ${s.detail}`.toLowerCase().includes(e)).slice(0,6);return`
  ...
  `}function Ia(){const e=ye(),a=Aa();return`
  ...
  `}function E(){const e=b();return O[e.id]||(O[e.id]={approvers:[{id:`${e.id}-principal`,name:"Principal Office",title:"Principal",active:!0},{id:`${e.id}-assistant-principal`,name:"Assistant Principal",title:"Assistant Principal",active:!0}],published:[{id:`${e.id}-welcome`,author:"School Office",role:"Administrator",type:"Announcement",audience:"All families",title:`Welcome to ${e.name}`,body:"This board is reserved for administrator-approved school community updates.",media:"No media",time:"Approved"}],pending:[]}),O[e.id]}function Fa(e){return e.approvers.find(a=>a.active)||e.approvers[0]}function Ga(e,a){var s;return((s=e.approvers.find(i=>i.id===a))==null?void 0:s.name)||"Unassigned"}function Ae(){const e=b();return N[e.id]||(N[e.id]={logo:Q(e.name).slice(0,1),crest:`${e.name} Crest`,primary:"#0050cb",accent:"#006b5f",highlight:"#735c00",background:"#f8f9ff",voice:"School-owned portal identity"}),N[e.id]}function Ha(e){return`--primary:${e.primary};--primary-2:${e.primary};--teal:${e.accent};--gold:${e.highlight};--background:${e.background};`}function nt(){const e=b();N[e.id]={...Ae(),logo:document.querySelector("#design-logo").value.trim()||Q(e.name).slice(0,1),crest:document.querySelector("#design-crest").value.trim()||`${e.name} Crest`,voice:document.querySelector("#design-voice").value.trim()||"School-owned portal identity",primary:document.querySelector("#design-primary").value,accent:document.querySelector("#design-accent").value,highlight:document.querySelector("#design-highlight").value,background:document.querySelector("#design-background").value}}function m(){const e=q.find(i=>i.id===t.role),a=b(),s=Ae();Oa.innerHTML=`
    <div class="app ${t.compactMode?"compact-mode":""} ${t.highContrast?"high-contrast":""}" style="${Ha(s)}">
      ${Wa(e,s)}
      <main class="workspace workspace-${t.role}">
        ...
        ${Ba()}
        ${ja()}
        ${t.role==="state-admin"?Ya():""}
        ${t.role==="district-admin"?Ka():""}
        ${t.role==="school-admin"?Qa():""}
        ${t.role==="lms"?Xa():""}
        ${t.role==="student"?ts():""}
        ${t.role==="teacher"?ss():""}
        ${t.role==="parent"?ns():""}
  ...
  `,hs(),vt(),Da()}function Ba(){if(!t.tourOpen)return"";const e=G[t.tourStep]||G[0];return`
  ...
  `}function Va(e){const a=e.id==="messages"?"Communication Hub":e.id==="state-admin"?"State Governance":e.id==="district-admin"?"District Operations":e.id==="school-admin"?"School Administration":`${e.label} Dashboard`;return`
    <header class="topbar">
      ...
      <div class="topbar-actions">
        ...
        <button class="icon-button" aria-label="Notifications" data-toggle-notifications>${r("bell")}${ve()?`<span class="status-dot">${ve()}</span>`:""}</button>
        <button class="icon-button" aria-label="Settings" data-toggle-settings>${r("settings")}</button>
      </div>
    </header>
  `}function Ya(){const e=de(),a=e.districts,s=a.flatMap(l=>l.schools),i=s.filter(l=>l.status==="Active").length;return`
    <section class="dashboard-grid platform-grid">
      ...
      <section class="panel state-management-panel">
        ...
        <div class="management-list">
          ${a.map(l=>`
            <button class="management-row ${l.id===Z().id?"active":""}" data-manage-district="${l.id}">
              <div class="management-icon">${r("building-2")}</div>
              <div><strong>${l.name}</strong><small>${l.region} • Superintendent: ${l.superintendent}</small></div>
              <span>${l.schools.length} schools</span>
            </button>
          `).join("")}
        </div>
      </section>
        ...
        <div class="audit-list">
          ${R.map(l=>`
            <article class="audit-row">
              ${r("clipboard-check")}
              <div><strong>${l.event}</strong><small>${l.actor} • ${l.scope}</small></div>
              <time>${l.time}</time>
            </article>
          `).join("")}
        </div>
      ...
      <section class="panel calendar-panel">
        ...
        <div class="calendar-list">
          ${ot.map(l=>`<article class="calendar-row"><div class="calendar-date">${l.date}</div><div><strong>${l.title}</strong><small>${l.audience} • ${l.type}</small></div></article>`).join("")}
        </div>
      </section>
      <section class="panel hierarchy-panel">
        <div class="section-heading"><h3>Governance Chain</h3><span>State to classroom</span></div>
        <div class="hierarchy-list">
          ${ma.map(([l,d],y)=>`<article class="hierarchy-level"><div class="level-number">${y+1}</div><div><h4>${l}</h4><p>${d.join(" • ")}</p></div></article>`).join("")}
        </div>
      </section>
      ${Za()}
    </section>
  `}function Ka(){const e=de(),a=Z(),s=a.schools,i=s.reduce((d,y)=>d+y.students,0),l=s.reduce((d,y)=>d+y.staff,0);return`
    <section class="dashboard-grid platform-grid">
      <div class="welcome-strip platform-welcome">
        <div>
      ...
      ${w("Staff",l.toLocaleString(),"shield-check","gold")}
  ...
  `}function Qa(){const e=b(),a=E(),s=k.filter(l=>l.status==="Watch").length,i=M.filter(l=>l.status!=="Reviewed").length;return`
    <section class="dashboard-grid platform-grid">
      <div class="welcome-strip platform-welcome">
        <div>
      ...
      <section class="panel permissions-panel">
        ...
        <div class="permission-table">
          ...
          <button class="permission-row" data-open-role="messages"><strong>Messages</strong><span>Family and staff communication</span><small>${S.reduce((l,d)=>l+(d.unread||0),0)} unread</small></button>
  ...
  `}function bt(){const e=b(),a=E(),s=Math.round(k.reduce((g,j)=>g+j.grade,0)/k.length),i=k.filter(g=>g.status==="Watch").length,l=M.filter(g=>g.status!=="Reviewed").length,d=S.reduce((g,j)=>g+(j.unread||0),0),y=[{role:"lms",label:"LMS",iconName:"layers",metric:`${C.length} assignments`,detail:`${l} gradebook items need review`},{role:"student",label:"Students",iconName:"sparkles",metric:`${k.length} learners`,detail:`${i} students on watch status`},{role:"teacher",label:"Teachers",iconName:"graduation-cap",metric:`${F.length} classes`,detail:`${W.length} activity events in the feed`},{role:"parent",label:"Parents",iconName:"users",metric:`${we.length} deadlines`,detail:`${t.checkedDeadlines.length} family tasks checked`},{role:"messages",label:"Messages",iconName:"message-circle",metric:`${d} unread`,detail:`${S.length} parent and group threads`},{role:"community",label:"Community",iconName:"megaphone",metric:`${a.pending.length} pending`,detail:`${a.published.length} approved posts live`}];return`
      ...
      <div class="system-snapshot-grid">
        <article class="system-snapshot-card">
          ...
          <div class="snapshot-metrics">
            ...
            <span><strong>${l}</strong><small>Submissions in queue</small></span>
        ...
        <article class="system-snapshot-card">
          ...
          <div class="snapshot-metrics">
            ...
            <span><strong>${ve()}</strong><small>Unread alerts</small></span>
  ...
  `}function Za(){const e=U.filter(s=>s.done).length,a=z.filter(s=>s.done).length;return`
      ...
      <div class="production-grid">
        ...
        <article class="production-card">
          ...
          <div class="checklist-list">
            ${U.map(s=>`<label class="checklist-row"><input type="checkbox" data-onboarding-task="${s.id}" ${s.done?"checked":""} /><span class="custom-check">${s.done?r("check"):""}</span><span><strong>${s.label}</strong><small>${s.owner}</small></span></label>`).join("")}
          </div>
        ...
        <article class="production-card">
          ...
          ${_.map(s=>`<div class="delivery-row"><strong>${s.channel}</strong><span>${s.audience}</span><em>${s.status}</em><small>${s.detail}</small></div>`).join("")}
        </article>
  ...
  `}function Xa(){const e=b(),a=$e.find(s=>s.id===t.activeAccount)||$e[0];return`
    <section class="dashboard-grid lms-grid">
      ...
      <section class="panel lms-panel simplicity-suite">
        ...
        ${ha.slice(0,2).map(([s,i])=>`<article class="strength-row">${r("check")}<div><strong>${s}</strong><small>${i}</small></div></article>`).join("")}
      </section>
      ...
      <section class="panel lms-panel account-suite">
        ...
        <div class="account-switcher">
          ${$e.map(s=>`<button class="${a.id===s.id?"active":""}" data-lms-account="${s.id}"><strong>${s.name}</strong><span>${s.context}</span></button>`).join("")}
        </div>
      ...
      <section class="panel lms-panel privacy-suite">
        ...
        ${ga.map(s=>`<article class="strength-row">${r("shield-check")}<div><strong>${s.label}</strong><small>${s.detail}</small></div></article>`).join("")}
      </section>
    </section>
  `}function es(){const e=M.find(a=>a.id===t.selectedSubmissionId)||M[0];return`
  ...
  `}function ts(){const e=b(),a=(e.studentPoints+t.completed.length*75).toLocaleString();return`
    <section class="dashboard-grid student-grid">
      ...
      <section class="panel missions-panel">
        ...
        <div class="mission-list">
          ${fe.map(s=>{const i=t.completed.includes(s.id);return`
    ...
    <section class="panel lms-panel background-services" aria-label="Passive background services">
      ...
      <div class="background-service-grid">
        <article class="background-service-card">
          ...
          <small>${st.length} connected services attach, collect, archive, and export in the background.</small>
          <span>Passive</span>
        </article>
        <article class="background-service-card">
        ...
        <article class="background-service-card">
          ...
          <small>${ot.length} shared events inform deadlines and family reminders in the background.</small>
          <span>Synced</span>
        </article>
      </div>
      <details class="background-details">
        ...
        <div class="background-activity">
          ${st.map(a=>`<article><strong>${a.app}</strong><small>${a.action}</small><span>${a.status}</span></article>`).join("")}
          ${te.map(a=>`<article><strong>${a.item}</strong><small>${a.owner}</small><span>${t.offlinePackReady?a.status:"Waiting"}</span></article>`).join("")}
        </div>
      </details>
    </section>
  `}function ss(){const e=b(),a=t.selectedClass==="All"?F:F.filter(i=>i.name===t.selectedClass),s=t.rosterFilter==="All"?k:k.filter(i=>i.status===t.rosterFilter);return`
    <section class="dashboard-grid teacher-grid">
      ...
      <section class="panel activity-panel">
        ...
        ${W.map(([i,l,d,y])=>`<article class="activity-row"><div class="avatar">${Q(i)}</div><div><p><strong>${i}</strong> ${l}</p><span>${d} | ${y}</span></div><button class="icon-button" aria-label="Reply to ${i}" data-reply-student="${i}">${r("pen-line")}</button></article>`).join("")}
      </section>
  ...
  `}function ns(){const e=b();return`
    <section class="dashboard-grid parent-grid">
      ...
      <section class="panel deadline-panel">
        ...
        ${we.map(a=>{const s=t.checkedDeadlines.includes(a.title);return`<label class="deadline-row ${a.urgent?"urgent":""}"><input type="checkbox" data-deadline="${a.title}" ${s?"checked":""} /><span class="custom-check">${s?r("check"):""}</span><span><strong>${a.title}</strong><small>${a.meta}</small></span></label>`}).join("")}
      </section>
      <section class="panel mobile-parent-panel">
        ...
        <div class="mobile-actions">
          ...
          ${fa.map(a=>`<article class="mobile-action">${r("smartphone")}<div><strong>${a.title}</strong><small>${a.detail}</small></div></article>`).join("")}
        </div>
      </section>
  ...
  `}function is(){const e=b(),a=S.filter(i=>i.type===t.conversationFilter),s=S.find(i=>i.id===t.activeConversationId)||a[0]||S[0];return`
  ...
  `}function os(){const e=b(),a=E(),s=Fa(a);return`
    <section class="dashboard-grid community-grid">
      ...
      <section class="panel approval-queue">
        ...
        <div class="queue-list">
          ${a.pending.length?a.pending.map(i=>rs(i)).join(""):'<div class="empty-state">No posts waiting for approval.</div>'}
        </div>
      </section>
      ...
      <section class="panel workflow-rules-panel">
        ...
        ${ba.map(([i,l])=>`<article class="rule-row"><strong>${i}</strong><span>${l}</span></article>`).join("")}
      </section>
    </section>
  `}function rs(e){const a=E();return`
    <article class="board-post pending-post">
      ...
      <div class="assigned-approver">${r("shield-check")} Assigned to ${Ga(a,e.approverId)}</div>
  ...
  `}function ls(){const e=Z(),a=e.schools.length+1,s=`demo-school-${Date.now()}`,i={id:s,name:`Demo Learning Academy ${a}`,category:"Public",students:240+a*18,staff:32+a,status:"Onboarding",subdomain:`demoacademy${a}`,plan:"District Core",modules:["SIS","LMS","Messaging","Family Portal"],storage:18,uptime:"Provisioning",theme:"Discovery Blue",isolation:"Dedicated tenant database",avgGrade:"89.0%",attendance:"95.0%",messages:"0 pending",studentPoints:760,studentName:"Explorer",guardianName:"Jordan",learnerName:"Riley",workHours:"Mon-Fri, 8:00 AM-4:00 PM",afterHours:"Messages are queued until office hours"};e.schools.push(i),t.selectedSchool=s,f("Created demo school tenant",e.name),t.toast=`${i.name} was added to ${e.name}.`,m()}function ds(){const e=`Quick Check ${C.length+1}`;yt({title:e,className:t.selectedClass==="All"?"All classes":t.selectedClass,type:"Teacher-created assignment",lockDate:"Next Friday, 8:00 PM"}),X("lms",`${e} was created in the LMS grading suite.`)}function yt({title:e,className:a,type:s,lockDate:i}){const l=`${e.toLowerCase().replace(/[^a-z0-9]+/g,"-")}-${Date.now()}`;C.unshift({id:l,title:e,type:s,rubric:"Auto rubric draft",analytics:0,lockDate:i||"Next Friday, 8:00 PM",exception:"None"});const d=k.find(y=>a==="All classes"||y.className===a)||k[0];d&&(M.unshift({id:`sub-${Date.now()}`,student:d.student,assignment:e,status:"Needs review",score:0,rubric:[["Completion",0],["Accuracy",0],["Explanation",0]],comment:"New assignment created. Awaiting student work."}),t.selectedSubmissionId=M[0].id),B("Action",`${e} is ready to publish`,a,"Teacher inbox"),P("LMS",`${e} created`,`${s} assigned to ${a}.`),f(`Created assignment ${e}`,b().name)}function us(){const e=fe.find(a=>!t.completed.includes(a.id));if(!e){v("All missions are complete. Reset the demo or wait for the next adventure.");return}t.completed.includes(e.id)||t.completed.push(e.id),v(`${e.title} marked complete. Points updated.`)}function ps(){W.unshift(["Demo Student","opened the newest assignment","Just now",t.selectedClass==="All"?"All Classes":t.selectedClass]),v("Student activity refreshed.")}function ms(e){t.conversationFilter="Groups",t.activeConversationId="grade-team",t.draft=`Following up about ${e}'s recent activity.`,X("messages",`Reply draft started for ${e}.`)}function hs(){var a,s,i,l,d,y,g,j,ue,pe,se,ne,me,ie,Le,Ee,De,Ne,Oe,xe,qe,Te,Re,je,Ie,Fe,Ge,He,Be,Ue,_e,ze,We,Je,Ve,Ye,Ke,Qe,Ze,Xe,et,tt;document.querySelectorAll("[data-role]").forEach(n=>{n.addEventListener("click",o=>{o.preventDefault(),be(n.dataset.role)})}),(a=document.querySelector("[data-reset-demo]"))==null||a.addEventListener("click",()=>{Na(),window.location.hash!=="#state-admin"&&history.pushState(null,"","#state-admin"),m()}),(s=document.querySelector("#global-search"))==null||s.addEventListener("input",n=>{t.searchTerm=n.target.value,m()}),(i=document.querySelector("[data-clear-search]"))==null||i.addEventListener("click",()=>{t.searchTerm="",m()}),document.querySelectorAll("[data-open-role]").forEach(n=>{n.addEventListener("click",()=>{var o;t.searchTerm="",X(n.dataset.openRole,`${((o=q.find(c=>c.id===n.dataset.openRole))==null?void 0:o.label)||"Workspace"} opened.`)})});function e(n,o="Signed in as"){n&&(t.currentUser=n.id,f(`Switched demo login to ${n.role}`,b().name,n.label),t.toast=`${o} ${n.label}.`,be(n.landing))}(l=document.querySelector("#login-profile"))==null||l.addEventListener("change",n=>{t.apiMode!=="live-api"&&e(A.find(o=>o.id===n.target.value))}),(d=document.querySelector("#login-form"))==null||d.addEventListener("submit",async n=>{n.preventDefault();const o=document.querySelector("#login-profile").value,c=A.find(u=>u.id===o);if(t.apiMode!=="live-api"){e(c);return}try{const u=await Pa(o,document.querySelector("#login-password").value);localStorage.setItem("educonnect-session-token",u.token),e(u.user,"Securely signed in as")}catch(u){v(u.message||"Invalid credentials.")}}),(y=document.querySelector("#api-mode"))==null||y.addEventListener("change",async n=>{if(t.apiMode=n.target.value,t.apiMode==="mock-api"||t.apiMode==="live-api"){try{await ht(t.apiMode),v(t.apiMode==="live-api"?"Server database mode enabled.":"Mock API mode enabled.")}catch{t.apiMode="local",v("Server API unavailable. Local demo state mode enabled.")}return}v("Local demo state mode enabled.")}),(g=document.querySelector("[data-start-tour]"))==null||g.addEventListener("click",()=>{t.tourOpen=!0,t.tourStep=0,X(G[0].role,"Walkthrough started.")}),(j=document.querySelector("[data-tour-next]"))==null||j.addEventListener("click",()=>{if(t.tourStep>=G.length-1){t.tourOpen=!1,v("Walkthrough complete.");return}t.tourStep+=1,X(G[t.tourStep].role)}),(ue=document.querySelector("[data-tour-prev]"))==null||ue.addEventListener("click",()=>{t.tourStep!==0&&(t.tourStep-=1,X(G[t.tourStep].role))}),document.querySelectorAll("[data-action]").forEach(n=>{n.addEventListener("click",()=>v(n.dataset.action))}),(pe=document.querySelector("[data-dismiss-toast]"))==null||pe.addEventListener("click",()=>{t.toast="",m()}),(se=document.querySelector("[data-toggle-notifications]"))==null||se.addEventListener("click",()=>{t.notificationsOpen=!t.notificationsOpen,t.settingsOpen=!1,m()}),(ne=document.querySelector("[data-toggle-settings]"))==null||ne.addEventListener("click",()=>{t.settingsOpen=!t.settingsOpen,t.notificationsOpen=!1,m()}),document.querySelectorAll("[data-close-panel]").forEach(n=>{n.addEventListener("click",()=>{t.notificationsOpen=!1,t.settingsOpen=!1,m()})}),(me=document.querySelector("[data-mark-notifications]"))==null||me.addEventListener("click",()=>{L.forEach(n=>{n.read=!0}),v("All notifications marked read.")}),document.querySelectorAll("[data-dismiss-notification]").forEach(n=>{n.addEventListener("click",()=>{const o=L.findIndex(c=>c.id===n.dataset.dismissNotification);o>=0&&L.splice(o,1),m()})}),document.querySelectorAll("[data-simulate-live]").forEach(n=>{n.addEventListener("click",()=>gt("manual"))}),(ie=document.querySelector("[data-toggle-live]"))==null||ie.addEventListener("change",n=>{t.liveUpdates=n.target.checked,v(t.liveUpdates?"Realtime updates enabled.":"Realtime updates paused.")}),(Le=document.querySelector("#auth-provider"))==null||Le.addEventListener("change",n=>{t.authProvider=n.target.value,f(`Updated auth provider to ${t.authProvider}`),v(`${t.authProvider} selected.`)}),(Ee=document.querySelector("#backend-provider"))==null||Ee.addEventListener("change",n=>{t.backendProvider=n.target.value,f(`Updated backend provider to ${t.backendProvider}`),v(`${t.backendProvider} selected as backend provider.`)}),document.querySelectorAll("[data-set-gateway]").forEach(n=>{n.addEventListener("click",()=>{t.gatewayMode=n.dataset.setGateway,P("Production","Gateway mode updated",`Launch gateway is now ${t.gatewayMode}.`),v(t.gatewayMode==="backend"?"Backend-ready mode enabled.":"Demo mode enabled.")})}),(De=document.querySelector("[data-provision-schema]"))==null||De.addEventListener("click",()=>{Y.forEach(n=>{n.status="Ready"}),P("Database","Mock schema provisioned",`${Y.length} production tables marked ready.`),f("Provisioned mock production schema"),v("Database blueprint marked ready.")}),document.querySelectorAll("[data-onboarding-task]").forEach(n=>{n.addEventListener("change",()=>{const o=U.find(c=>c.id===n.dataset.onboardingTask);o&&(o.done=n.checked,f(`${o.done?"Completed":"Reopened"} onboarding task: ${o.label}`),v("Onboarding checklist updated."))})}),(Ne=document.querySelector("#onboarding-user-form"))==null||Ne.addEventListener("submit",n=>{n.preventDefault();const o=document.querySelector("#onboarding-user-name").value.trim(),c=document.querySelector("#onboarding-user-role").value;if(!o)return;const u=c==="Admin"?"school-admin":c.toLowerCase();A.push({id:`${c.toLowerCase()}-${Date.now()}`,label:o,role:c,landing:u,permissions:c==="Admin"?["manage-tenants","approve-posts","emergency","lms","teacher-tools","message","manage-users","view-compliance"]:c==="Teacher"?["lms","teacher-tools","message","submit-post"]:c==="Parent"?["message","submit-post"]:["student-missions"]}),B("Action",`${o} invited`,b().name,"Onboarding"),f(`Invited ${c}: ${o}`),v(`${o} invited as ${c}.`)}),(Oe=document.querySelector("#production-file-upload"))==null||Oe.addEventListener("change",async n=>{var c;const o=Array.from(n.target.files||[]);for(const u of o)if(t.apiMode==="live-api")try{const I=await Ca(u,t.role==="community"?"Community":"LMS");x.unshift(I.file)}catch{x.unshift({id:`upload-${Date.now()}-${Math.random().toString(16).slice(2)}`,name:u.name,area:t.role==="community"?"Community":"LMS",size:`${Math.max(1,Math.round(u.size/1024))} KB`,status:"Server upload failed; metadata stored locally"})}else x.unshift({id:`upload-${Date.now()}-${Math.random().toString(16).slice(2)}`,name:u.name,area:t.role==="community"?"Community":"LMS",size:`${Math.max(1,Math.round(u.size/1024))} KB`,status:"Stored in demo metadata; ready for cloud storage"});P("Files","Upload metadata captured",`${((c=n.target.files)==null?void 0:c.length)||0} file(s) added to production upload queue.`),f("Added production upload metadata"),v("File upload metadata added.")}),(xe=document.querySelector("[data-send-delivery-test]"))==null||xe.addEventListener("click",async()=>{if(t.apiMode==="live-api")try{(await La("Launch test group")).records.forEach(o=>_.unshift(o))}catch{["Email","SMS","Push"].forEach(n=>{_.unshift({id:`delivery-${Date.now()}-${n}`,channel:n,audience:"Launch test group",status:"Failed over locally",detail:`${n} test could not reach operational API`})})}else["Email","SMS","Push"].forEach(n=>{_.unshift({id:`delivery-${Date.now()}-${n}`,channel:n,audience:"Launch test group",status:"Delivered",detail:`${n} test generated from Launch Control`})});B("FYI","Notification delivery test completed",b().name,"Launch Control"),f("Sent notification delivery test batch"),v("Notification delivery test completed.")}),document.querySelectorAll("[data-security-check]").forEach(n=>{n.addEventListener("change",()=>{const o=z.find(c=>c.id===n.dataset.securityCheck);o&&(o.done=n.checked,o.status=o.done?"Configured":"Needs review",f(`Updated security checklist: ${o.label}`),v("Security checklist updated."))})}),document.querySelectorAll("[data-toggle-setting]").forEach(n=>{n.addEventListener("change",()=>{t[n.dataset.toggleSetting]=n.checked,m()})}),(qe=document.querySelector("[data-export-demo]"))==null||qe.addEventListener("click",async()=>{const n=JSON.stringify(mt(),null,2),o=new Blob([n],{type:"application/json"}),c=URL.createObjectURL(o),u=document.createElement("a");u.href=c,u.download="educonnect-demo-state.json",u.click(),URL.revokeObjectURL(c),f("Exported demo state JSON");try{await navigator.clipboard.writeText(n),v("Demo state exported and copied to clipboard.")}catch{v("Demo state exported as a JSON file.")}}),(Te=document.querySelector("#import-demo-state"))==null||Te.addEventListener("change",async n=>{var c;const o=(c=n.target.files)==null?void 0:c[0];if(o)try{const u=JSON.parse(await o.text()),I=Ta(u);if(I.length){v(`Import failed: ${I.join(" ")}`);return}Me(u),f("Imported demo state JSON"),v("Demo state imported.")}catch{v("That JSON file could not be imported.")}}),(Re=document.querySelector("[data-add-school]"))==null||Re.addEventListener("click",ls),(je=document.querySelector("[data-create-assignment]"))==null||je.addEventListener("click",ds),(Ie=document.querySelector("#assignment-form"))==null||Ie.addEventListener("submit",n=>{n.preventDefault();const o=document.querySelector("#assignment-title").value.trim();if(!o)return;const c=document.querySelector("#assignment-class").value;yt({title:o,className:c,type:document.querySelector("#assignment-type").value,lockDate:document.querySelector("#assignment-lock").value.trim()}),v(`${o} added to ${c}.`)}),(Fe=document.querySelector("[data-continue-adventure]"))==null||Fe.addEventListener("click",us),(Ge=document.querySelector("[data-refresh-activity]"))==null||Ge.addEventListener("click",ps),document.querySelectorAll("[data-reply-student]").forEach(n=>{n.addEventListener("click",()=>ms(n.dataset.replyStudent))}),document.querySelectorAll("[data-guardrail]").forEach(n=>{n.addEventListener("change",()=>{t.guardrails[n.dataset.guardrail]=n.checked,f(`Updated guardrail ${n.dataset.guardrail}`),v("Guardrail setting updated.")})}),document.querySelectorAll("[data-profile-permission]").forEach(n=>{n.addEventListener("change",()=>{const[o,c]=n.dataset.profilePermission.split(":"),u=A.find(I=>I.id===o);u&&(u.permissions=n.checked?[...new Set([...u.permissions,c])]:u.permissions.filter(I=>I!==c),f(`Updated ${u.role} permission: ${c}`),v(`${u.role} permissions updated.`))})}),document.querySelectorAll("[data-submission]").forEach(n=>{n.addEventListener("click",()=>{t.selectedSubmissionId=n.dataset.submission,m()})}),document.querySelectorAll("[data-save-submission]").forEach(n=>{n.addEventListener("click",()=>{const o=M.find(c=>c.id===n.dataset.saveSubmission);o&&(o.comment=document.querySelector("#submission-comment").value.trim(),o.status="Reviewed",f(`Saved gradebook comment for ${o.student}`,o.assignment),v("Gradebook comment saved."))})}),document.querySelectorAll("[data-complete]").forEach(n=>{n.addEventListener("click",()=>{const o=Number(n.dataset.complete);t.completed.includes(o)||t.completed.push(o);const c=fe.find(u=>u.id===o);v(`${(c==null?void 0:c.title)||"Mission"} marked complete.`)})}),(He=document.querySelector("#class-filter"))==null||He.addEventListener("change",n=>{t.selectedClass=n.target.value,m()}),(Be=document.querySelector("#roster-filter"))==null||Be.addEventListener("change",n=>{t.rosterFilter=n.target.value,m()}),document.querySelectorAll("[data-roster-grade], [data-roster-attendance], [data-roster-status]").forEach(n=>{n.addEventListener("change",()=>{const o=n.dataset.rosterGrade||n.dataset.rosterAttendance||n.dataset.rosterStatus,c=k.find(u=>u.id===o);c&&(n.dataset.rosterGrade&&(c.grade=Math.max(0,Math.min(100,Number(n.value)||0))),n.dataset.rosterAttendance&&(c.attendance=Math.max(0,Math.min(100,Number(n.value)||0))),n.dataset.rosterStatus&&(c.status=n.value),P("Roster",`${c.student} record updated`,`Grade ${c.grade}%, attendance ${c.attendance}%, status ${c.status}.`),f(`Updated roster record for ${c.student}`,c.className),v(`${c.student}'s roster record updated.`))})}),document.querySelectorAll("[data-lms-account]").forEach(n=>{n.addEventListener("click",()=>{t.activeAccount=n.dataset.lmsAccount,m()})}),(Ue=document.querySelector("[data-build-offline]"))==null||Ue.addEventListener("click",()=>{t.offlinePackReady=!0,te.forEach(n=>{n.status=n.status.replace("Waiting for pack","Queued for upload")}),v("Offline pack built and sync queue prepared.")}),(_e=document.querySelector("#state-filter"))==null||_e.addEventListener("change",n=>{t.selectedState=n.target.value;const o=de();t.selectedDistrict=o.districts[0].id,t.selectedSchool=o.districts[0].schools[0].id,m()}),(ze=document.querySelector("#district-filter"))==null||ze.addEventListener("change",n=>{t.selectedDistrict=n.target.value,t.selectedSchool=Z().schools[0].id,m()}),(We=document.querySelector("#school-filter"))==null||We.addEventListener("change",n=>{t.selectedSchool=n.target.value,m()}),(Je=document.querySelector("#design-form"))==null||Je.addEventListener("change",()=>{nt(),m()}),(Ve=document.querySelector("#design-form"))==null||Ve.addEventListener("submit",n=>{n.preventDefault(),nt(),m()}),document.querySelectorAll("[data-design-preset]").forEach(n=>{n.addEventListener("click",()=>{const o=b(),c=ya.find(u=>u.name===n.dataset.designPreset);c&&(N[o.id]={...Ae(),...c},m())})}),document.querySelectorAll("[data-manage-district]").forEach(n=>{n.addEventListener("click",()=>{t.selectedDistrict=n.dataset.manageDistrict,t.selectedSchool=Z().schools[0].id,m()})}),document.querySelectorAll("[data-manage-school]").forEach(n=>{n.addEventListener("click",()=>{t.selectedSchool=n.dataset.manageSchool,m()})}),document.querySelectorAll("[data-deadline]").forEach(n=>{n.addEventListener("change",()=>{const o=n.dataset.deadline;t.checkedDeadlines=t.checkedDeadlines.includes(o)?t.checkedDeadlines.filter(c=>c!==o):[...t.checkedDeadlines,o],m()})}),document.querySelectorAll("[data-filter]").forEach(n=>{n.addEventListener("click",()=>{t.conversationFilter=n.dataset.filter;const o=S.find(c=>c.type===t.conversationFilter);o&&(t.activeConversationId=o.id),m()})}),document.querySelectorAll("[data-conversation]").forEach(n=>{n.addEventListener("click",()=>{t.activeConversationId=n.dataset.conversation;const o=S.find(c=>c.id===t.activeConversationId);o&&(o.unread=0),m()})}),(Ye=document.querySelector("#message-draft"))==null||Ye.addEventListener("input",n=>{t.draft=n.target.value}),(Ke=document.querySelector("[data-toggle-hours]"))==null||Ke.addEventListener("click",()=>{t.workHoursOpen=!t.workHoursOpen,m()}),(Qe=document.querySelector("[data-toggle-emergency]"))==null||Qe.addEventListener("click",()=>{t.emergencyOverride=!t.emergencyOverride,f(`${t.emergencyOverride?"Enabled":"Disabled"} emergency override`),m()}),document.querySelectorAll("[data-start-call]").forEach(n=>{n.addEventListener("click",()=>{const o=S.find(c=>c.id===n.dataset.startCall);o&&(t.activeCallName=o.name,P("Messages",`Live call started with ${o.name}`,"Video room is active in the communication hub."),f(`Started video call with ${o.name}`,b().name),v(`Video call started with ${o.name}.`))})}),(Ze=document.querySelector("[data-end-call]"))==null||Ze.addEventListener("click",()=>{const n=t.activeCallName;t.activeCallName="",n&&P("Messages",`Live call ended with ${n}`,"Call state closed."),v("Video call ended.")}),(Xe=document.querySelector("#compose"))==null||Xe.addEventListener("submit",n=>{if(n.preventDefault(),!t.workHoursOpen&&!t.emergencyOverride)return;const o=t.draft.trim();o&&(S.splice(0,S.length,...S.map(c=>c.id===t.activeConversationId?{...c,preview:o,messages:[...c.messages,{from:"me",text:o,time:"Now"}]}:c)),P("Messages","Message sent",`Delivered to ${ye().label}'s active conversation.`),B("FYI","Message delivered",b().name,"Messages"),t.draft="",m())}),(et=document.querySelector("#board-form"))==null||et.addEventListener("submit",n=>{n.preventDefault();const o=b();E().pending.unshift({id:`${o.id}-${Date.now()}`,author:document.querySelector("#board-author").value.trim()||"Community Member",role:document.querySelector("#board-role").value,type:document.querySelector("#board-type").value,audience:document.querySelector("#board-audience").value,title:document.querySelector("#board-title").value.trim(),body:document.querySelector("#board-body").value.trim(),media:document.querySelector("#board-media").value.trim()||"No media",approverId:document.querySelector("#board-approver").value,time:"Awaiting administrator approval"}),P("Community","Community post submitted",`${document.querySelector("#board-title").value.trim()} is waiting for approval.`),B("Action","Community post awaiting approval",o.name,"Approval queue"),f("Submitted community post for approval",o.name),v("Post submitted for administrator approval.")}),document.querySelectorAll("[data-approver-toggle]").forEach(n=>{n.addEventListener("change",()=>{const o=E();o.approvers=o.approvers.map(c=>c.id===n.dataset.approverToggle?{...c,active:n.checked}:c),m()})}),(tt=document.querySelector("#approver-form"))==null||tt.addEventListener("submit",n=>{n.preventDefault();const o=E(),c=document.querySelector("#new-approver-name").value.trim();c&&(o.approvers.push({id:`${c.toLowerCase().replace(/[^a-z0-9]+/g,"-")}-${Date.now()}`,name:c,title:document.querySelector("#new-approver-title").value,active:!0}),m())}),document.querySelectorAll("[data-approve-post]").forEach(n=>{n.addEventListener("click",()=>{const o=E(),c=o.pending.find(u=>u.id===n.dataset.approvePost);c&&(o.pending=o.pending.filter(u=>u.id!==c.id),o.published.unshift({...c,time:"Approved just now"}),f(`Approved community post: ${c.title}`),m())})}),document.querySelectorAll("[data-reject-post]").forEach(n=>{n.addEventListener("click",()=>{const o=E(),c=o.pending.find(u=>u.id===n.dataset.rejectPost);o.pending=o.pending.filter(u=>u.id!==n.dataset.rejectPost),c&&f(`Rejected community post: ${c.title}`),m()})})}async function gs(){if(Ea(),t.apiMode==="mock-api"||t.apiMode==="live-api")try{await ht(t.apiMode)}catch{t.apiMode="local",t.toast="Server API unavailable. Local demo state mode enabled."}Se()&&(t.role=Se()),window.addEventListener("hashchange",()=>{const e=Se();e&&e!==t.role&&be(e,!1)}),window.addEventListener("load",vt),m(),window.setInterval(()=>{!t.liveUpdates||document.hidden||gt("automatic")},15e3)}gs();
